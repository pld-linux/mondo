...
Summary(es.UTF-8):   mondo - un programa para los usuarios de Linux por crear una CD/cinta de restoracion/rescate
Summary(fr.UTF-8):   mondo - un programme pour les utilisateurs de Linux pour crï¿½r un CD/tape de sauvegarde/restauration
Summary(it.UTF-8):   mondo - un programma per utenti Linux per creare un CD/tape di rescue
Summary(pl.UTF-8):   mondo - program do tworzenia kopii zapasowych na CD/taśmie i odtwarzania z nich
Name:		mondo
Version:	2.04
Release:	1
License:	GPL
...
Program do robienia kopii zapasowych. Współpracuje z CD-R(RW),
streamerami, NFS, LVM, RAID, ext2, ext3, JFS, XFS, ReiserFS, VFAT,
NTFS.

%package xmondo
Summary:	A QT based graphical front end for mondo
Summary(pl.UTF-8):   Graficzna nakładka do mondoarchive oparta o QT
Group:		Applications/Archiving
...
%description xmondo -l pl.UTF-8
xmondo jest graficzną nakładką do mondoarchive opartą o QT.

%package devel
Summary:	Header files for building against mondo
Summary(pl.UTF-8):   Pliki nagłówkowe bibliotek mondo
...
Pliki nagłówkowe bibliotek mondo.
